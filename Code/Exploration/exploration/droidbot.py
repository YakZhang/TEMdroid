    ...
    def __init__(self,
        ...
        try:
            self.device = Device(
                ...
                src_csv_name=src_csv_name,
                tgt_xml_prefix=tgt_xml_prefix,
                src_tgt_pair_path=src_tgt_pair_path,
                predict_threhold=predict_threhold,
                new_function_threhold=new_function_threhold,
                dfs_graph=dfs_graph,
