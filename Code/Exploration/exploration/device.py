...
class Device(object):
    ...
    def __init__(self, device_serial=None, is_emulator=False, output_dir=None,
                 ...
                 src_csv_prefix=None, src_csv_name=None, tgt_xml_prefix=None,
                 src_tgt_pair_path=None,predict_threhold=None,new_function_threhold=None,dfs_graph=None,tgt_apk_name=None):
        """
        ...
        # parameters for combine Migration
        self.src_csv_prefix = src_csv_prefix
        self.src_csv_name = src_csv_name
        self.tgt_xml_prefix = tgt_xml_prefix
        self.src_tgt_pair_path = src_tgt_pair_path
        self.predict_threhold = predict_threhold
        self.new_function_threhold = new_function_threhold
        self.dfs_graph = dfs_graph
        self.tgt_apk_name=tgt_apk_name
